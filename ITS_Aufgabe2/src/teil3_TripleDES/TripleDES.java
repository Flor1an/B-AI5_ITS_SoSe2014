 ...
 * 
 * a. Implementieren Sie in JAVA ein Programm TripleDES mit der Aufgabe, alle
 * Bytes einer beliebigen Datei mit dem TripleDES-Verfahren zu verschlüsseln
 * oder zu entschlüsseln. Ihr Programm soll mit drei verschiedenen
 * DES-Schlüsseln arbeiten und in der Reihenfolge EDE(encrypt-decrypt-encrypt)
 * das DES-Verfahren dreimal hintereinander durchlaufen. Implementieren Sie als
 * Blockchiffre Betriebsart den CFB-Modus.
 * 
