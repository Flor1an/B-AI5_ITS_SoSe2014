...
class WebServer {
    ...
    public final String DOCS_DIR = "www/";
    public Integer serverPort = null;
    private String jksFile = null;
    ...
    private void runWebServer() {
        ...
        int cnt = 0;
        try {
            System.out.println("Waiting for connections using port " + serverPort + " with root dir " + DOCS_DIR);

            SSLContext context = SSLContext.getInstance("TLS");
            KeyManagerFactory kmf = KeyManagerFactory.getInstance("SunX509");
            char[] storepass = "123456".toCharArray();
            char[] keypass = "123456".toCharArray();
            String storename = this.jksFile;
    ...
    private class WorkerThread extends Thread {
        ...
        private WebServer server; // the caller
        ...
        // constructor
        public WorkerThread(WebServer server, int num, Socket socket, String dir) {
            this.server = server;
            this.name = num;
            this.sock = socket;
            this.defaultDir = dir;
